...
namespace Awesome.Library.Cryptography {
	...
	public static class Base32Encoding {
		...
		public static byte[] Decode( string base32 ) {
			...
			switch ( len % 8 ) { // test the length of last subblock
